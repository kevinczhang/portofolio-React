...
const About = () => (
  ...
  <div className="timeline-item">
    <div className="timeline-icon">
      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fillRule="evenodd" clipRule="evenodd"><path d="M9 21h-9v-2h9v2zm6.695-2.88l-3.314-3.13-1.381 1.47 4.699 4.54 8.301-8.441-1.384-1.439-6.921 7zm-6.695-1.144h-9v-2h9v2zm8-3.976h-17v-2h17v2zm7-4h-24v-2h24v2zm0-4h-24v-2h24v2z"/></svg>
    </div>
    <div className="timeline-content">
      <p className="timeline-content-date">2008</p>
  ...
  <div className="timeline-item">
    ...
    <div className="timeline-content right">
      <p className="timeline-content-date">2010</p>
  ...
  <div className="timeline-item">
    <div className="timeline-icon">
      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fillRule="evenodd" clipRule="evenodd"><path d="M17 24h-10l-2-14h14l-2 14zm-.592-10h-8.816l.571 4h7.674l.571-4zm1.631-8c0 .922 1.092 1.618 1.961 1.618v1.382h-16v-1.382c.87 0 2-.697 2-1.618h12.039zm-7.73-.691c2.819-2.143-.594-2.353.077-3.868-2.361 2.113.85 2.169-.077 3.868zm2.486-.001c4.236-3.238-.877-3.067.105-5.308-3.382 2.895 1.259 2.959-.105 5.308z"/></svg>
    </div>
    <div className="timeline-content">
      <p className="timeline-content-date">2011</p>
      <p>
  ...
  <div className="timeline-item">
    <div className="timeline-icon">
      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fillRule="evenodd" clipRule="evenodd"><path d="M7.467 0c1.102.018 5.555 2.549 6.386 8.558.905-.889 1.409-3.664 1.147-4.843 3.952 2.969 6 6.781 6 11.034 0 5.094-3.43 9.251-8.963 9.251-5.728 0-9.037-3.753-9.037-8.276 0-6.26 5.052-7.62 4.467-15.724zm3.262 19.743c-.749.848-.368 1.945.763 2.045 1.035.093 1.759-.812 2.032-1.792.273-.978.09-2.02-.369-2.893-.998 1.515-1.52 1.64-2.426 2.64zm4.42 1.608c2.49-1.146 3.852-3.683 3.852-6.58 0-2.358-.94-4.977-2.5-7.04-.743 2.867-2.924 3.978-4.501 4.269.05-3.219-.318-6.153-2.602-8.438-.296 4.732-4.321 7.63-4.398 12.114-.029 1.511.514 3.203 1.73 4.415.491.489 1.054.871 1.664 1.16-.121-.608-.062-1.254.195-1.848.911-2.106 3.333-2.321 4.202-5.754.952.749 3.275 3.503 2.778 6.358-.082.469-.224.923-.42 1.344z"/></svg>
    </div>
    <div className="timeline-content">
      <p className="timeline-content-date">2013 - <span className="timeline-content-month">february</span></p>
  ...
  <div className="timeline-item">
    <div className="timeline-icon">
      <img src="https://cdns.iconmonstr.com/wp-content/assets/preview/2017/96/iconmonstr-candy-26.png" className="" height="21" width="21" alt=""/>
    </div>
    <div className="timeline-content right">
      <p className="timeline-content-date">2013 - <span className="timeline-content-month">november</span></p>
  ...
  <div className="timeline-item">
    <div className="timeline-icon">
      <img src="https://cdns.iconmonstr.com/wp-content/assets/preview/2017/96/iconmonstr-fast-food-10.png" className="" height="21" width="21" alt=""/>
    </div>
    <div className="timeline-content">
      <p className="timeline-content-date">2013 - <span className="timeline-content-month">november</span></p>
  ...
  <div className="timeline-item">
    <div className="timeline-icon">
      <img src="https://cdns.iconmonstr.com/wp-content/assets/preview/2017/96/iconmonstr-fast-food-12.png" className="" height="21" width="21" alt=""/>
    </div>
    <div className="timeline-content right">
      <p className="timeline-content-date">2014 - <span className="timeline-content-month">november</span></p>
  ...
  <div className="timeline-item">
    <div className="timeline-icon">
      <img src="https://cdns.iconmonstr.com/wp-content/assets/preview/2017/96/iconmonstr-fast-food-5.png" className="" height="21" width="21" alt=""/>
    </div>
    <div className="timeline-content">
      <p className="timeline-content-date">2015</p>
  ...
  <div className="timeline-item">
    <div className="timeline-icon">
      <img src="https://cdns.iconmonstr.com/wp-content/assets/preview/2017/96/iconmonstr-check-mark-18.png" className="" height="21" width="21" alt=""/>
    </div>
    <div className="timeline-content right">
      <p className="timeline-content-date">2016</p>
